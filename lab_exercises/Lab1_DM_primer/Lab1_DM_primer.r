...
# With minor updates by OS Nov 2023 and Nov 2025
...
# WARNING! This exercise neither demonstrates all aspects of good modelling practice,
# nor great models - it is just a quick and simple start.

# Preparations (Lab0):
# Download and install R: https://cran.r-project.org/
# Download and install R studio: https://www.rstudio.com/
# Download Lab material from github
# Download and install packages:
# install.packages(c("terra", "fields"))
...
# Load packages
library(terra)  # for raster data tools
library(fields) # for tim.colors and other color palettes

# Load training data
load("lab_data/DM_primer_training_data")  # loads the data set 'training_data'
...
temp <- rast("lab_data/DM_primer_predictor_map.grd")
...
# Interpret and discuss the models. The species is Picea sitchensis (Sitka spruce, 'sitkagran' in Norwegian).
