...
# Which variables show ecologically reasonable/interpretable patterns?
...
plot(ps,main="Selected glm")  # Make sure ps contains predictions for Picea sitchensis (run relevant lines in Lab3 solutions script if necessary)
points(training_data$x,training_data$y,pch=".",cex=2,col=c("blue","red")[training_data$presence+1]) # Presences and random absences on elevation map

# The model can be evaluated with 'testAUC' for independent data

# Climate change effects:
summary(ms)        # Positive effect: warmer temperatures (run relevant lines in Lab3 solutions script to get ms)
...
# cv.folds=5 (instead of test.percent=20). Compare results to 2b: How / why do they differ?
...
# in various packages, eg. 'sdm', 'dismo', 'biomod2', 'AICcmodavg',
# 'ENMTools', 'ENMeval' and 'vandalico'
